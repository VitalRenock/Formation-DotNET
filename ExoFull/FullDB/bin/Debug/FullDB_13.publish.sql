...
CREATE TABLE [dbo].[Game] (
    ...
    [TypeGame]  NVARCHAR (10) NULL,
    [NbJoueurs] INT           NULL,
    [Plateform] NVARCHAR (10) NULL,
...
GO
INSERT INTO Game (Title, Cote, Editor, TypeGame, NbJoueurs, Plateform) VALUES
('Super Mario Bros', 8,'Nintendo', 'Plateformer', 2, 'Super NES'),
('Myst', 9,'Cyan Games', 'Adventure', 1, 'PC'),
('Mario Kart 64', 7,'Nintendo', 'Course', 4, 'Nintendo 64'),
('Street fighters 2', 8,'Capcom', 'Combat', 2, 'Super NES');
GO
